...
Shader "UnityChan/UCTS_Standard_StencilOut" {
    Properties {
        _StencilNo ("Stencil No", int) =1
		_StencilOutAlpha("Stencil Out Alpha", int) = 0.5
...
//�����܂�.
    ...
    SubShader {
		...
		#pragma only_renderers d3d9 d3d11 glcore gles gles3 metal xboxone ps4 switch
		#pragma target 3.0
				uniform float _StencilOutAlpha;
